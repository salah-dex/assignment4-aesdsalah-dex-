...
typedef struct thread_data{
     ...
     */
        /**
        * The mutex the thread should obtain and release.
        */
    pthread_mutex_t *mutex;
    /**
     * The number of milliseconds the thread should wait before
     * attempting to obtain the mutex.
     */
    int wait_to_obtain_ms;
    /**
     * The number of milliseconds the thread should hold the mutex.
     */
